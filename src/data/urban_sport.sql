...
CREATE TABLE `brands` (
  ...
  `name` varchar(55) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `productId` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_7bd8dbae-84c8-4751-8118-6e68b9f12182` (`productId`),
  CONSTRAINT `FK_7bd8dbae-84c8-4751-8118-6e68b9f12182` FOREIGN KEY (`productId`) REFERENCES `products` (`id`)
...
CREATE TABLE `colour_product` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_3e1f6daf-fbf6-4934-962e-b3401572bcea` (`id_colours`),
  CONSTRAINT `FK_3e1f6daf-fbf6-4934-962e-b3401572bcea` FOREIGN KEY (`id_colours`) REFERENCES `colours` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_user` int(11) NOT NULL,
  `factura` varchar(100) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `talle_product` (
  ...
  `id_product` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_de6770a1-3363-4455-ab89-7df9f20ba5d1` (`id_talle`),
  CONSTRAINT `FK_de6770a1-3363-4455-ab89-7df9f20ba5d1` FOREIGN KEY (`id_talle`) REFERENCES `talles` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `talles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `talle` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) COLLATE utf8_spanish2_ci NOT NULL,
  `last_name` varchar(65) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `email` varchar(70) COLLATE utf8_spanish2_ci NOT NULL,
  `password` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `phone` int(45) DEFAULT NULL,
  `address` varchar(125) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
-- Dump completed on 2021-10-14 11:00:34
